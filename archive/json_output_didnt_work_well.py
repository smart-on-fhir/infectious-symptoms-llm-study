...
criteria_verbose = "Three criteria define True or False for each symptom.\n"
criteria_verbose += f"Criteria 1 is {crit1}\n\n"

criteria_verbose += f"Criteria 2 is {crit2}\n\n"
criteria_verbose += (
    "Include positive symptom mentions from these medical section headings :\n"
    + ",\n".join(crit2_include)
    + ".\n\n"
)
criteria_verbose += (
    "Exclude any symptom mentions from these medical section headings :\n"
    + ",\n".join(crit2_exclude)
    + ".\n\n"
)
...
criteria_verbose += (
    "Include positive symptom for this JSON of symptom synonyms:\n"
    + json.dumps(crit3_include)
    + ".\n\n"
)
criteria_verbose += (
    "Exclude all symptom for this JSON of symptom synonyms:\n"
...
criteria_exclude = "Three criteria define True or False for each symptom.\n"
...
prompt_identity += (
    " Always output your answer in JSON where the values are True or False keys are the name of each symptom:\n"
    + ",\n".join(symptom_list)
    + ".\n\n"
)
